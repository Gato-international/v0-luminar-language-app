...
export default async function TextLearningPage() {
    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Text Learning</p>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <h2 className="text-3xl font-bold mb-2">Text Learning</h2>
          <p className="text-muted-foreground">Improve your grammar by practicing with full sentences.</p>
        </div>
